...
/**
 * Created by Escapist on 2017/5/31.
 */
...
public class PhotoShow extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendRequestWithHttpURLConnection(path);
        handler = new Handler(){
            @Override
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    ...
                    case MESSAGE_RESULT_ERR:
                        Toast.makeText(PhotoShow.this,"照片获取失败",Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    httpRequestor.requestNet(url, handler);
                } catch (Exception e) {
                    e.getMessage();
                    Looper.prepare();
                    Toast.makeText(PhotoShow.this,"请检查网络设置",Toast.LENGTH_SHORT).show();
                    Looper.loop();
                }
            }
        }).start();
